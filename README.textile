...
The rewrite gem is not in active development at this time. Instead, I am working on "RewrteRails":http://github.com/raganwald/rewrite_rails. RewriteRails brings Rewrite's functionality to Ruby on Rails projects.
